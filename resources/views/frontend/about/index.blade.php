    ...
    <div class="row px-xl-5">
        <div class="col-lg-7 mb-5">
            <div class="about-text-wrap">
                ...
                <p>We provide the best Beard oile all over the world. We are the worldd best store in indi for Beard Oil. You can
                    buy our product without any hegitation because they truste us and buy our product without any hagitation because
                    they belive and always happy buy our product.</p>
                <p>Some of our customer say’s that they trust us and buy our product without any hagitation because they belive us
                    and always happy to buy our product.</p>
                <p>We provide the beshat they trusted us and buy our product without any hagitation because they belive us and
        ...
        <div class="row no-gutters">
            ...
            <div class="col-lg-3 col-md-6">
                ...
                <div class="limupa-counter gray-bg">
                    <div class="counter-img">
                        <img src="{{ asset('front/images/about-us/icon/2.png') }}" alt="">
                    </div>
                    <div class="counter-info">
                        <div class="counter-number">
            ...
            <div class="col-lg-3 col-md-6">
                ...
                <div class="limupa-counter white-smoke-bg">
                    <div class="counter-img">
                        <img src="{{ asset('front/images/about-us/icon/3.png') }}" alt="">
                    </div>
                    <div class="counter-info">
                        <div class="counter-number">
            ...
            <div class="col-lg-3 col-md-6">
                ...
                <div class="limupa-counter gray-bg">
                    <div class="counter-img">
                        <img src="{{ asset('front/images/about-us/icon/4.png') }}" alt="">
                    </div>
                    <div class="counter-info">
                        <div class="counter-number">
                            <h3 class="counter">2169</h3>
        ...
        <div class="row">
            ...
            <div class="col-lg-3 col-md-6 col-sm-6">
                <div class="team-member mb-30 mb-sm-60">
                    <div class="team-thumb">
                        <img src="{{ asset('front/images/team/3.png') }}" alt="Our Team Member">
                    </div>
                    <div class="team-content text-center">
                        <h3>Erik Jonson</h3>
                        <p>Web Developer</p>
            ...
            <div class="col-lg-3 col-md-6 col-sm-6">
                <div class="team-member mb-30 mb-sm-60 mb-xs-60">
                    <div class="team-thumb">
                        <img src="{{ asset('front/images/team/4.png') }}" alt="Our Team Member">
                    </div>
                    <div class="team-content text-center">
                        <h3>Maria Mandy</h3>
