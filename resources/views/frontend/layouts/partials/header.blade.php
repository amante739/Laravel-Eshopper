            ...
            <div class="row">
                ...
                <div class="col-lg-3 col-md-4">
                    <div class="header-top-left">
                        <ul class="phone-wrap">
                            <li><span>Telephone Enquiry:</span><a href="#"> {{ $setting_data['site_phone'] }}</a></li>
                        </ul>
                    </div>
                </div>
                        ...
                        <ul class="ht-menu">
                            ...
                            <li>
                                ...
                                <div class="language ht-language">
                                    <ul class="ht-setting-list">
                                        <li class="active"><a><img src="{{ asset('front/images/menu/flag-icon/1.jpg') }}" alt="">English</a></li>
            ...
            <div class="row">
                ...
                <div class="col-lg-3">
                    <div class="logo pb-sm-30 pb-xs-30">
                        <a href="{{ url('/') }}">
                            <img class="img-fluid" src="{{ asset('front/images/menu/logo/1.png') }}" alt="">
                        </a>
                    </div>
                </div>
                                ...
                                <div class="minicart">
                                    ...
                                    <ul class="minicart-product-list">
                                        ...
                                        <li data-id="{{ $id }}">
                                            ...
                                            <button class="close remove-from-cart" >
                                    ...
                                    @else
                                    <div class="minicart-button">
                                        <a class="li-button li-button-dark li-button-fullwidth li-button-sm" style="background-color: #212529 !important;">
                        ...
                        <nav>
                            <ul>
                                ...
                                <li class="hb-info f-right p-0 d-sm-none d-lg-block">
                                    <span>{{ $setting_data['site_address'] }}</span>
                                </li>
